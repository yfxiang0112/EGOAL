...
for accession in accessions['accession']:
    ...
    '''
    #gse_path = "dataset/GSE102264/GSE102264_series_matrix.csv"
    gse_path = "dataset/GSE102264_family.soft.gz"
    gpl_path = "dataset/GSE102264/GPL17650_022828_D_GEO_20090205.txt.gz"
    gse = GEOparse.get_GEO(filepath=gse_path)
    #gse = GEOparse.get_GEO(geo="GSE102264", destdir="dataset")
    print(gse)
    '''
